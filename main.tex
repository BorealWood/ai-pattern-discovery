...
\begin{enumerate}
    ...
    \item \textbf{Simulation}: Implement computational model in Python (NumPy, SciPy) with documented initial conditions, boundary conditions, and numerical methods. Simulation code at \url{https://github.com/BorealWood/ai-pattern-discovery} enables independent verification.
...
All simulation code, validation data, and analysis scripts are released open-source under Apache 2.0 license at \url{https://github.com/BorealWood/ai-pattern-discovery} to enable independent verification, replication, and extension by the scientific community.
...
Repository: \url{https://github.com/BorealWood/ai-pattern-discovery}
